...
EOD
    ...
    public function main_content($content, $semantic = '') {
        $this->main .= $semantic . $content;
    }

    public function content($content, $semantic = '') {
        $this->main .= $semantic . $content;
    }

    public function set_property($property, $value, $semantic = '') {
        switch ($property) {
            case 'lang':
                $this->lang = $value;
                break;
